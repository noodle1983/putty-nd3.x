...
#ifndef __view_framework_native_scroll_bar_wrapper_h__
#define __view_framework_native_scroll_bar_wrapper_h__
...
#endif //__view_framework_native_scroll_bar_wrapper_h__