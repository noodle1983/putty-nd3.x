...
#ifndef __view_framework_menu_scroll_view_container_h__
#define __view_framework_menu_scroll_view_container_h__
...
#endif //__view_framework_menu_scroll_view_container_h__