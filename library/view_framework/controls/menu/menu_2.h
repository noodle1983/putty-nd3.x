...
#ifndef __view_framework_menu_2_h__
#define __view_framework_menu_2_h__
...
namespace view
{
    ...
    public:
        ...
        explicit Menu2(MenuModel* model);
        virtual ~Menu2();
        ...
        // Accessors.
        MenuModel* model() const { return model_; }
...
#endif //__view_framework_menu_2_h__