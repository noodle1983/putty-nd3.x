...
#ifndef __view_framework_native_menu_win_h__
#define __view_framework_native_menu_win_h__
...
namespace view
{
    ...
    public:
        ...
        NativeMenuWin(MenuModel* model, HWND system_menu_for);
    ...
    private:
        ...
        static bool GetHighlightedMenuItemInfo(HMENU menu,
            bool* has_parent, bool* has_submenu);
...
#endif //__view_framework_native_menu_win_h__