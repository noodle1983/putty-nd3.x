...
#ifndef __view_framework_native_control_h__
#define __view_framework_native_control_h__
...
namespace view
{
    ...
    protected:
        ...
        virtual bool OnKeyDown(KeyboardCode virtual_key_code) { return false; }
...
#endif //__view_framework_native_control_h__