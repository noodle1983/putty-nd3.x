...
namespace view
{
    ...
    void NonClientView::GetAccessibleState(AccessibleViewState* state)
    {
        state->role = AccessibilityTypes::ROLE_WINDOW;
    ...
    void NonClientFrameView::GetAccessibleState(AccessibleViewState* state)
    {
        state->role = AccessibilityTypes::ROLE_WINDOW;
    }
