...
namespace base
{
    ...
    // 注意: 保持枚举顺序以便调用者可以"if(GetWinVersion() >= WINVERSION_VISTA) ...".
    enum WinVersion
    {
        WINVERSION_PRE_XP = 0, // 不支持.
        WINVERSION_XP,
        WINVERSION_SERVER_2003, // Also includes Windows XP Professional x64.
        WINVERSION_VISTA,
        WINVERSION_SERVER_2008,
        WINVERSION_WIN7,
    };
    ...
    public:
        ...
        WinVersion version() const { return version_; }
