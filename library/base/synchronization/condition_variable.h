...
#ifndef __base_synchronization_condition_variable_h__
#define __base_synchronization_condition_variable_h__
...
#endif //__base_synchronization_condition_variable_h__