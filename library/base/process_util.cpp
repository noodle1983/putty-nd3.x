...
#include "diagnose/stack_trace.h"
#include "logging.h"
...
namespace base
{
        ...
        ProcessHandle* process_handle)
    {
        ...
        if(!CreateProcess(NULL, const_cast<wchar_t*>(cmdline.c_str()),
            NULL, NULL, inherit_handles, 0, NULL, NULL,
    ...
    bool LaunchApp(const std::wstring& cmdline, bool wait,
    ...
    bool LaunchApp(const CommandLine& cl, bool wait,
        bool start_hidden, ProcessHandle* process_handle)
    {
