...
#ifndef __view_input_method_h__
#define __view_input_method_h__
...
namespace view
{
    ...
    public:
        ...
        virtual void set_delegate(InputMethodDelegate* delegate) = 0;
        ...
        virtual base::TextDirection GetInputTextDirection() = 0;
        ...
        // TEXT_INPUT_TYPE_NONE if there is no focused text input client.
        virtual TextInputType GetTextInputType() const = 0;
    };

} //namespace view

#endif //__view_input_method_h__