...
#ifndef __view_ime_input_h__
#define __view_ime_input_h__
...
namespace view
{
    ...
    public:
        ...
        base::TextDirection GetTextDirection() const;
        ...
        static bool IsCtrlShiftPressed(base::TextDirection* direction);
