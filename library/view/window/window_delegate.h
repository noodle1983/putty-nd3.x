...
#ifndef __view_framework_window_delegate_h__
#define __view_framework_window_delegate_h__
...
namespace view
{
    ...
    public:
        ...
        virtual AccessibilityTypes::Role GetAccessibleWindowRole() const;

        virtual AccessibilityTypes::State GetAccessibleWindowState() const;
...
#endif //__view_framework_window_delegate_h__