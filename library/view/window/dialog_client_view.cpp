...
#include "view/controls/button/native_button.h"
...
namespace view
{
        ...
        View* focused_now)
    {
        ...
        if(focused_now && focused_now->GetClassName()==NativeButton::kViewClassName)
        {
        ...
        else
        {
            ...
            // delegate.
            DialogDelegate* dd = GetDialogDelegate();
            if((dd->GetDefaultDialogButton()&ui::MessageBoxFlags::DIALOGBUTTON_OK) != 0)
            {
