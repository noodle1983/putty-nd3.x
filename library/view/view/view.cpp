...
namespace view
{
    ...
    View::View()
        ...
        texture_id_(0), // TODO: 0可以作为合法的texture id.
    ...
    {
        ViewVector::const_iterator it = std::find(children_.begin(),
            children_.end(), view);
    ...
    {
        return base::IsRTL() ? (width()-bounds.x()-bounds.width()) :
            bounds.x();
    }
    ...
    void View::Paint(gfx::Canvas* canvas)
    {
        ...
        else
        {
            ...
            if(transform_.get() && transform_->HasChange())
            {
                canvas->ConcatTransform(*transform_.get());
            }
        }
    ...
    void View::PaintComposite(gfx::Compositor* compositor)
    {
    ...
    void View::OnFocus()
    {
        ...
        GetWidget()->NotifyAccessibilityEvent(this,
            AccessibilityTypes::EVENT_FOCUS, true);
    }
