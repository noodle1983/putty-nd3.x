...
#ifndef __view_framework_view_h__
#define __view_framework_view_h__
...
namespace view
{
    ...
    protected:
        ...
        virtual void PaintComposite(gfx::Compositor* compositor);
...
#endif //__view_framework_view_h__