...
namespace view
{
        ...
        frame_(frame)
    {
        ...
        close_button_->SetAccessibleName(GetStringUTF16(IDS_APP_ACCNAME_CLOSE));

        // Close button images will be set in LayoutWindowControls().
        AddChildView(close_button_);

        restore_button_->SetAccessibleName(
            GetStringUTF16(IDS_APP_ACCNAME_RESTORE));
        ...
        maximize_button_->SetAccessibleName(
            GetStringUTF16(IDS_APP_ACCNAME_MAXIMIZE));
        ...
        minimize_button_->SetAccessibleName(
            GetStringUTF16(IDS_APP_ACCNAME_MINIMIZE));
    ...
    void CustomFrameView::ButtonPressed(Button* sender, const view::Event& event)
    {
    ...
    void CustomFrameView::PaintRestoredFrameBorder(gfx::Canvas* canvas)
    {
        ...
        SkBitmap* top_right_corner = rb.GetBitmapNamed(IDR_WINDOW_TOP_RIGHT_CORNER);
        ...
        canvas->FillRectInt(frame_color, 0, frame_image->height(),
    ...
    void CustomFrameView::PaintMaximizedFrameBorder(gfx::Canvas* canvas)
    {
        ...
        SkBitmap* titlebar_bottom = rb.GetBitmapNamed(
            IDR_APP_TOP_CENTER);
    ...
    void CustomFrameView::PaintTitleBar(gfx::Canvas* canvas)
    {
        ...
        canvas->DrawStringInt(d->GetWindowTitle(), *title_font_, SK_ColorWHITE,
            GetMirroredXForRect(title_bounds_), title_bounds_.y(),
    ...
    void CustomFrameView::LayoutWindowControls()
    {
        ...
        close_button_->SetBounds(
            width()-FrameBorderThickness()-right_extra_width-close_button_size.width(),
            caption_y,
    ...
    void CustomFrameView::LayoutTitleBar()
    {
        ...
        title_bounds_.SetRect(title_x,
            ...
            std::max(0, (should_show_minmax_buttons_?minimize_button_->x():
            close_button_->x())-kTitleCaptionSpacing-title_x),
            title_height);
    }
