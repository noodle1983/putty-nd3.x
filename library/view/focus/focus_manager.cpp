...
namespace view
{
    ...
    bool FocusManager::OnKeyEvent(const KeyEvent& event)
    {
        ...
        KeyboardCode key_code = event.key_code();
            ...
            key_code==VKEY_LEFT || key_code==VKEY_RIGHT))
        {
            ...
            focused_view_->parent()->GetViewsWithGroup(
    ...
    {
        return key_event.key_code()==VKEY_TAB && !key_event.IsControlDown();
    }
        ...
        HWND native_view)
    {
        ...
        view::NativeWidget* native_widget =
            view::NativeWidget::GetTopLevelNativeWidget(native_view);
