...
#include "base/diagnose/stack_trace.h"
...
//}
//
//int ResourceBundle::ConvetAppId(AppId app_id) const
//{
//    int id = 0;
//
//    base::AutoLock lock_scope(*lock_);
//    if(id_conveter_.get())
//    {
//        id = id_conveter_->AppIdToResId(app_id);
//    }
//    else
//    {
//        NOTREACHED();
...
//}
//
//SkBitmap* ResourceBundle::GetBitmapAppNamed(AppId app_id)
//{
//    return GetBitmapNamed(ConvetAppId(app_id));
//}
//
//string16 ResourceBundle::GetLocalizedAppString(AppId app_id)
//{
//    return GetLocalizedString(ConvetAppId(app_id));
//}
