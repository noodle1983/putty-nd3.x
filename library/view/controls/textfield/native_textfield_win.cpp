...
namespace view
{
        ...
        bg_color_(0)
    {
        ...
        DWORD ex_style = GetExtendedStyles();
        ...
        base::ScopedComPtr<IRichEditOle, &IID_IRichEditOle> ole_interface;
    ...
    string16 NativeTextfieldWin::GetText() const
    {
        ...
        // "(Google (by default".
        return base::StripWrappingBidiControlCharacters(WideToUTF16(str));
    }
    ...
    void NativeTextfieldWin::GetSelectedRange(Range* range) const
    {
        NOTREACHED();
    }

    void NativeTextfieldWin::SelectRange(const Range& range)
    {
        NOTREACHED();
    }
        ...
        MenuAccelerator* accelerator)
    {
        ...
        {
        case IDS_APP_CUT:
            *accelerator = Accelerator(VKEY_X, false, true, false);
            return true;
        case IDS_APP_COPY:
            *accelerator = Accelerator(VKEY_C, false, true, false);
            return true;
        case IDS_APP_PASTE:
            *accelerator = Accelerator(VKEY_V, false, true, false);
            return true;
        }
    ...
    void NativeTextfieldWin::OnPaste()
    {
        ...
        Clipboard* clipboard = ViewDelegate::view_delegate->GetClipboard();
    ...
    void NativeTextfieldWin::HandleKeystroke()
    {
        ...
        if(!handled)
        {
            ...
            if(msg->wParam==VKEY_HOME || msg->wParam==VKEY_END)
            {
        ...
        bool is_triple_click) const
    {
        ...
        if((pf2.wEffects & PFE_RTLPARA) || base::StringContainsStrongRTLChars(GetText()))
        {
