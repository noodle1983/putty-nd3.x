...
namespace view
{
    ...
    // A model that represents a text content for TextfieldView.
    ...
    public:
        ...
        void GetSelectedRange(Range* range) const;

        // The current composition text will be confirmed.
        void SelectRange(const Range& range);
        ...
        string16 GetTextFromRange(const Range& range) const;

        // Retrieves the range containing all text in the model.
        void GetTextRange(Range* range) const;
        ...
        // composition text.
        void SetCompositionText(const CompositionText& composition);
        ...
        void GetCompositionTextRange(Range* range) const;
    ...
    private:
        ...
        // Pointer to a TextfieldViewModel::Delegate instance, should be provided by
        // the View object.
        Delegate* delegate_;
        ...
        CompositionUnderlines composition_underlines_;
