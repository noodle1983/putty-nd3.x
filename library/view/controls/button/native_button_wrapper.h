...
#ifndef __view_native_button_wrapper_h__
#define __view_native_button_wrapper_h__
...
namespace view
{
    ...
    public:
        ...
        static NativeButtonWrapper* CreateNativeButtonWrapper(
            NativeButton* button);
        static NativeButtonWrapper* CreateCheckboxWrapper(NativeCheckbox* checkbox);
...
#endif //__view_native_button_wrapper_h__