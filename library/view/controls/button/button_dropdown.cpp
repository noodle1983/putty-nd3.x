...
namespace view
{
    ...
    void ButtonDropDown::GetAccessibleState(AccessibleViewState* state)
    {
        CustomButton::GetAccessibleState(state);
        state->role = AccessibilityTypes::ROLE_BUTTONDROPDOWN;
    ...
    bool ButtonDropDown::ShouldEnterPushedState(const MouseEvent& event)
    {
        ...
        return ((EF_LEFT_BUTTON_DOWN |
            EF_RIGHT_BUTTON_DOWN)&event.flags()) != 0;
    }
