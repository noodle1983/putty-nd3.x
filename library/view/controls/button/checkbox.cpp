...
namespace view
{
    ...
    // static
    const char NativeCheckbox::kViewClassName[] = "view/NativeCheckbox";
    ...
    NativeCheckbox::NativeCheckbox(const std::wstring& label)
        : NativeButton(NULL, label), checked_(false)
    {
        Init(label);
    }
    ...
    gfx::Size NativeCheckbox::GetPreferredSize()
    {
        ...
        prefsize.set_width(prefsize.width()+kCheckboxLabelSpacing+
    ...
    void NativeCheckbox::Layout()
    {
        ...
        else
        {
            ...
            label_->SetBounds(label_x, 0,
                std::max(0, width()-label_x-kLabelFocusPaddingHorizontal),
                height());
