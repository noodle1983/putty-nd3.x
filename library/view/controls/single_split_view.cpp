...
namespace view
{
    ...
    void SingleSplitView::GetAccessibleState(AccessibleViewState* state)
    {
        state->role = AccessibilityTypes::ROLE_GROUPING;
        ...
        gfx::Rect* trailing_bounds) const
    {
        ...
        bool is_trailing_visible = child_count()>1 && GetChildViewAt(1)->IsVisible();
        ...
        int divider_size = !is_leading_visible ||
            !is_trailing_visible ? 0 : kDividerSize;
        ...
        else
        {
            ...
            *trailing_bounds = gfx::Rect(0, divider_at+divider_size,
                bounds.width(),
        ...
        const gfx::Rect& bounds) const
    {
        ...
        return std::min(divider_offset, std::max(primary_axis_size-kDividerSize, 0));
    }
