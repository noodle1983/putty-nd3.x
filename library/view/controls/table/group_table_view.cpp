...
namespace view
{
    ...
    GroupTableView::GroupTableView(GroupTableModel* model,
        ...
        : TableView(model, columns, table_type, false,
        resizable_columns, autosize_columns),
        model_(model),
    ...
    bool GroupTableView::OnKeyDown(ui::KeyboardCode virtual_keycode)
    {
        ...
        // will be selected.
        if((virtual_keycode!=ui::VKEY_UP) && (virtual_keycode!=ui::VKEY_DOWN))
        {
