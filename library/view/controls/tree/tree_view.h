...
namespace view
{
    ...
    public:
        ...
        virtual void OnTreeViewKeyDown(KeyboardCode keycode) {}
    };
    ...
    protected:
        ...
        // start editting.
        virtual bool OnKeyDown(KeyboardCode virtual_key_code);
    ...
    private:
        ...
        struct NodeDetails
        {
            NodeDetails(int id, TreeModelNode* node) : id(id), node(node),
