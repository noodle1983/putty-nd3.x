...
namespace view
{
    ...
    {
        widget_delegate_ = params.delegate ? params.delegate
    ...
    {
        native_widget_->ShowNativeWidget(internal::NativeWidgetPrivate::SHOW_INACTIVE);
    }
            ...
            else
            {
                ...
                if(saved_bounds.width() < minimum_size_.width())
                {
                    saved_bounds.SetRect(saved_bounds.x(), saved_bounds.y(),
                        saved_bounds.right()+minimum_size_.width()-saved_bounds.width(),
                        saved_bounds.bottom());
                }
