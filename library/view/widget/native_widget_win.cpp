...
#include "view/widget/aero_tooltip_manager.h"
...
namespace view
{
    ...
    namespace
    {
            ...
            unsigned long flags)
        {
            ...
            else
            {
                ...
                gfx::Rect work_area = Screen::GetMonitorWorkAreaNearestPoint(
                    bounds.origin());
    ...
    bool NativeWidgetWin::ContainsNativeView(HWND native_view) const
    {
