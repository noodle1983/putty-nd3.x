...
#ifndef __wan_chrome_tab_tab_strip_model_observer_h__
#define __wan_chrome_tab_tab_strip_model_observer_h__
...
#endif //__wan_chrome_tab_tab_strip_model_observer_h__