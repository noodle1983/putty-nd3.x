...
#ifndef __wan_chrome_tab_tab_strip_model_delegate_h__
#define __wan_chrome_tab_tab_strip_model_delegate_h__
...
public:
    ...
    // Creates an appropriate TabContents. This is handled by the delegate
    // since the TabContents may require special circumstances to
    // exist for it to be constructed (e.g. a parent HWND).
    virtual TabContentsWrapper* CreateTabContents(
...
#endif //__wan_chrome_tab_tab_strip_model_delegate_h__