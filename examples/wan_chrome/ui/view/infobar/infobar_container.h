...
#ifndef __wan_chrome_ui_view_infobar_infobar_container_h__
#define __wan_chrome_ui_view_infobar_infobar_container_h__
...
#endif //__wan_chrome_ui_view_infobar_infobar_container_h__