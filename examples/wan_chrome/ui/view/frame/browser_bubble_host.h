...
#ifndef __wan_chrome_ui_view_frame_browser_bubble_host_h__
#define __wan_chrome_ui_view_frame_browser_bubble_host_h__
...
#endif //__wan_chrome_ui_view_frame_browser_bubble_host_h__