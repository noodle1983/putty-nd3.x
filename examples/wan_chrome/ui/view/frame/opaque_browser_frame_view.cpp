...
#include "view_framework/base/window_shape.h"
                                               ...
                                               browser_view_(browser_view)
{
    ...
    minimize_button_->SetAccessibleName(
        view::GetStringUTF16(IDS_ACCNAME_MINIMIZE));
    ...
    maximize_button_->SetAccessibleName(
        view::GetStringUTF16(IDS_ACCNAME_MAXIMIZE));
    ...
    restore_button_->SetAccessibleName(
        view::GetStringUTF16(IDS_ACCNAME_RESTORE));
    ...
    close_button_->SetAccessibleName(
        view::GetStringUTF16(IDS_ACCNAME_CLOSE));
...
gfx::Size OpaqueBrowserFrameView::GetMinimumSize()
{
    ...
    int min_titlebar_width = (2 * FrameBorderThickness(false)) +
        kIconLeftSpacing + (delegate && delegate->ShouldShowWindowIcon() ?
        (IconSize()+kTitleLogoSpacing) : 0);
    min_titlebar_width += minimize_button_->GetMinimumSize().width() +
...
int OpaqueBrowserFrameView::NonClientTopBorderHeight(bool restored,
...
void OpaqueBrowserFrameView::PaintRestoredClientEdge(gfx::Canvas* canvas)
{
    ...
    if(browser_view_->IsToolbarVisible())
    {
        ...
        gfx::Rect toolbar_bounds;/*WLW TODO: fix it(browser_view_->GetToolbarBounds());*/
    ...
    canvas->DrawBitmapInt(*tp->GetBitmapNamed(IDR_CONTENT_BOTTOM_RIGHT_CORNER),
...
void OpaqueBrowserFrameView::LayoutWindowControls()
{
    ...
    visible_button->SetBounds(close_button_->x()-visible_button_size.width(),
        caption_y, visible_button_size.width(), visible_button_size.height());
