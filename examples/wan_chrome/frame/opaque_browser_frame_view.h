...
#ifndef __wan_chrome_frame_opaque_browser_frame_view_h__
#define __wan_chrome_frame_opaque_browser_frame_view_h__
...
#endif //__wan_chrome_frame_opaque_browser_frame_view_h__