    ...
    PrefNotifier* pref_notifier)
{
    ...
    return new PrefValueStore(managed_platform_prefs, managed_cloud_prefs,
        extension_prefs, command_line_prefs, user_prefs,
        recommended_platform_prefs, recommended_cloud_prefs,
...
void PrefValueStore::NotifyPrefChanged(const char* path,
