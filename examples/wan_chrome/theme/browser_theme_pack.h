...
#ifndef __wan_chrome_theme_browser_theme_pack_h__
#define __wan_chrome_theme_browser_theme_pack_h__
...
public:
    ...
    bool GetTint(int id, gfx::HSL* hsl) const;
...
private:
    ...
    void ParseImageNamesFromJSON(DictionaryValue* images_value,
        FilePath images_path, FilePathMap* file_paths) const;
    ...
    // processed_bitmaps.
    void GenerateTintedButtons(const gfx::HSL& button_tint,
    ...
    gfx::HSL GetTintInternal(int id) const;
...
#endif //__wan_chrome_theme_browser_theme_pack_h__