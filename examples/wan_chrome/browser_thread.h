...
#ifndef __wan_chrome_browser_thread_h__
#define __wan_chrome_browser_thread_h__
...
public:
    ...
    static bool PostTask(ID identifier, Task* task);
    static bool PostDelayedTask(ID identifier, Task* task, int64 delay_ms);
    static bool PostNonNestableTask(ID identifier, Task* task);
    static bool PostNonNestableDelayedTask(ID identifier, Task* task,
        int64 delay_ms);

    template<class T>
    static bool DeleteSoon(ID identifier, const T* object)
    {
        return PostNonNestableTask(identifier, new DeleteTask<T>(object));
    }

    template<class T>
    static bool ReleaseSoon(ID identifier, const T* object)
    {
        return PostNonNestableTask(identifier, new ReleaseTask<T>(object));
    }
...
#endif //__wan_chrome_browser_thread_h__