...
#ifndef __wan_chrome_common_notification_service_h__
#define __wan_chrome_common_notification_service_h__
...
#endif //__wan_chrome_common_notification_service_h__