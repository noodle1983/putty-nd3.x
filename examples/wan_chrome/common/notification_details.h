...
#ifndef __wan_chrome_common_notification_details_h__
#define __wan_chrome_common_notification_details_h__
...
#endif //__wan_chrome_common_notification_details_h__